...
public partial class Pages_Content_News_Add : System.Web.UI.Page
{
    ...
    private void init()
    {
        ...
        if (_News.NewsID > 0) _News = _News.Get();
        ...
        if (_News.ImageUrl.Length > 0) imgImageUrl.ImageUrl = Constant.MEDIA_PATH + _News.ImageUrl;
    ...
    {
        int newsID = Convert.ToInt32(lblNewsID.Text);
        if (newsID < 1) return;
        NewsPublish _NewsPublish = new NewsPublish();
    ...
    protected void btDelete_Click(object sender, EventArgs e)
    {
        ...
        _News.Delete();
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.NewsAddList);
    }
