<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/EditPage.master" AutoEventWireup="true" CodeFile="Users.Edit.aspx.cs" Inherits="Pages_Admin_Users_Edit" %>
    ...
    <div id="main-container">
        <div class="main-header clearfix">
            <div class="page-title">
                <h3 class="no-margin">
                    <asp:Literal ID="ltrTitle" runat="server">Cập nhật tài khoản</asp:Literal>
                </h3>
                <span>
                    ...
                    <div id="formToggleLine" class="form-horizontal no-margin form-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">Bỏ trống nếu không đổi mật khẩu.</span>
