<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/ListPage.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Pages_List" %>
			...
			<div class="panel-heading">
                <div class="row">
                    <div class="pull-right">
                        <a class="btn btn-sm btn-primary small"><i class="fa fa-plus"></i> Thêm mới</a>
                        <a class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Sửa</a>
                        <a class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i> Xoá</a>
                    </div>
