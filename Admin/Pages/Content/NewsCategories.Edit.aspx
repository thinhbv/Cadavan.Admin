<%@ Page Language="C#" MasterPageFile="~/Controls/AdminPage.master" AutoEventWireup="true" CodeFile="NewsCategories.Edit.aspx.cs" Inherits="Pages_Content_NewsCategories_Edit" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<article>
	<asp:Label ID="lblTtitle" runat="server" Text="Cập nhật chuyên mục" CssClass="title"></asp:Label>
    <form class="uniform">
	    <dl class="inline">
