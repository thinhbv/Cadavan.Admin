<%@ Page Language="C#" MasterPageFile="~/Controls/AdminPage.master" AutoEventWireup="true"
    CodeFile="News.Edit.aspx.cs" Inherits="Pages_Content_News_Edit" ValidateRequest="false" EnableEventValidation="false" %>
...
<article>
    ...
    <div class="uniform">
	    <dl>
		    ...
		    <dt><label for="newstitle">Thêm ảnh</label>  <asp:HyperLink ID="hplUpload" runat="server">Upload</asp:HyperLink></dt>
		    <dd>
		        <small>Bài viết nên có ảnh đại diện, kích cỡ tối đa 800 x 600 px, độ lớn 200Kb.</small>
	    ...
	    <p>
	        ...
	        <asp:Button ID="btReject" runat="server" Text="TỪ CHỐI" OnClick="btReject_Click" CssClass="button small orange" Width="80px"></asp:Button>
...
<%--txtRelatedID--%>
<ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="txtRelatedID" WatermarkText="Nhập ID bài viết" />
