<%@ Page Language="C#" MasterPageFile="~/Controls/AdminPage.master" AutoEventWireup="true" CodeFile="Functions.Add.aspx.cs" Inherits="Pages_Security_Functions_Add" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<article>
	<asp:Label ID="lblTtitle" runat="server" Text="Thêm mới quyền hệ thống" CssClass="title"></asp:Label><br /><br />
    <form class="uniform">
	    <dl class="inline">
			...
			<dd>
				<asp:CheckBox ID="cbxIsDisplay" Checked="true" runat="server"></asp:CheckBox>
			</dd>
		</dl>
	    <p>
	        <asp:Button ID="btAdd" runat="server" Text="THÊM" CssClass="button blue" OnClick="btAdd_Click" Width="80px"></asp:Button>
